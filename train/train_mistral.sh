...
CUDA_VISIBLE_DEVICES=0,1,2,3 accelerate launch -m --num_processes 4 --mixed_precision=bf16 train.main_mistral --tmpdir /media/data4/eagle_experiments/data/sharegpt_0_67999_mufp16 \
